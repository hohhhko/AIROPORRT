...
namespace Аэропрот
{
    public partial class FormTablo : Form
    {
        ...
        private async void FormTablo_Load(object sender, EventArgs e)
        {
            ...
            SQLiteDataAdapter dataadapter1 = new SQLiteDataAdapter("SELECT * FROM Reisi", DB);
            DataSet dr = new DataSet();

            dataadapter1.Fill(dr, "Info");
            DataGridReisi.DataSource = dr.Tables[0];
